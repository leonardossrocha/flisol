...
--
-- Table structure for table `lime_old_survey_736931_20150407093920`
--

DROP TABLE IF EXISTS `lime_old_survey_736931_20150407093920`;
CREATE TABLE `lime_old_survey_736931_20150407093920` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  ...
  PRIMARY KEY (`id`),
  KEY `idx_survey_token_736931_41385` (`token`)
) ENGINE=MyISAM AUTO_INCREMENT=7 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

--
-- Dumping data for table `lime_old_survey_736931_20150407093920`
--

INSERT INTO `lime_old_survey_736931_20150407093920` (`id`,`token`,`submitdate`,`lastpage`,`startlanguage`,`startdate`,`datestamp`,`ipaddr`,`refurl`,`736931X3X2`,`736931X3X2comment`,`736931X3X3`,`736931X3X4`,`736931X3X5`,`736931X3X6`,`736931X3X7`,`736931X3X8`,`736931X3X8comment`,`736931X3X9`) VALUES
('5', NULL, NULL, '1', 'pt-BR', '2015-04-07 08:48:58', '2015-04-07 08:48:58', '191.177.54.43', 'http://leonardorocha.eti.br/pesquisa/index.php/admin/survey/sa/view/surveyid/736931', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
('6', NULL, NULL, '1', 'en', '2015-04-07 08:51:10', '2015-04-07 08:51:41', '191.177.54.43', 'http://leonardorocha.eti.br/pesquisa/index.php/admin/survey/sa/view/surveyid/736931', '', '', '', '', NULL, NULL, '', '', '', '');
